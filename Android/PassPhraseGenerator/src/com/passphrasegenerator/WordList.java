...
public class WordList {
	...
	public static String[] wordList = { "A", "ABE", "ACE", "ACT", "AD", "ADA", "ADD",
		...
		/*
		 * Following words are from http://www.giwersworld.org/computers/linux/common-words.phtml.
		 * Used Mass Text editors to remove words 4 characters or less that is covered by previous 
		 * list AND add quotation marks and commas etc to save time. (I was not going to go 
		 * through the list manually) 
		 */
		
		"ABOUT", "ABOVE", "ACCORDING", "ACCOUNT", "ACROSS", "ACTION", "ACTIVITIES", 
		"ACTIVITY", "ACTUALLY", "ADDED", "ADDITION", "ADDITIONAL", "ADMINISTRATION", 
		"AFTER", "AGAIN", "AGAINST", "AHEAD", "ALMOST", "ALONE", "ALONG", "ALREADY", 
		"ALTHOUGH", "ALWAYS", "AMERICA", "AMERICAN", "AMONG", "AMOUNT", "ANALYSIS", 
		"ANOTHER", "ANSWER", "ANYONE", "ANYTHING", "APPARENTLY", "APPEAR", "APPEARED", 
		"APPROACH", "AREAS", "AROUND", "ASKED", "ASSOCIATION", "ATTACK", "ATTENTION", 
		"AUDIENCE", "AVAILABLE", "AVERAGE", "BASED", "BASIC", "BASIS", "BEAUTIFUL", 
		"BECAME", "BECAUSE", "BECOME", "BEFORE", "BEGAN", "BEGINNING", "BEHIND", "BEING", 
		"BELIEVE", "BELOW", "BETTER", "BETWEEN", "BEYOND", "BLACK", "BLOOD", "BOARD", 
		"BRING", "BRITISH", "BROUGHT", "BROWN", "BUILDING", "BUILT", "BUSINESS", "CALLED", 
		"CANNOT", "CARRIED", "CASES", "CAUSE", "CENTER", "CENTRAL", "CENTURY", "CERTAIN", 
		"CERTAINLY", "CHANCE", "CHANGE", "CHANGES", "CHARACTER", "CHARGE", "CHIEF", "CHILD", 
		"CHILDREN", "CHOICE", "CHRISTIAN", "CHURCH", "CLASS", "CLEAR", "CLEARLY", "CLOSE", 
		"CLOSED", "COLLEGE", "COLOR", "COMES", "COMING", "COMMITTEE", "COMMON", "COMMUNIST", 
		"COMMUNITY", "COMPANY", "COMPLETE", "COMPLETELY", "CONCERNED", "CONDITIONS", "CONGRESS", 
		"CONSIDER", "CONSIDERED", "CONTINUED", "CONTROL", "CORNER", "CORPS", "COSTS", "COULD", 
		"COULDNT", "COUNTRIES", "COUNTRY", "COUNTY", "COUPLE", "COURSE", "COURT", "COVERED", 
		"DAILY", "DEATH", "DECIDED", "DECISION", "DEFENSE", "DEGREE", "DEMOCRATIC", "DEPARTMENT", 
		"DESCRIBED", "DESIGN", "DESIGNED", "DETERMINED", "DEVELOPED", "DEVELOPMENT", "DIDNT", 
		"DIFFERENCE", "DIFFERENT", "DIFFICULT", "DIRECT", "DIRECTION", "DIRECTLY", "DISTANCE", 
		"DISTRICT", "DOING", "DOUBT", "DRIVE", "DURING", "EARLIER", "EARLY", "EARTH", "ECONOMIC", 
		"EDUCATION", "EFFECT", "EFFECTIVE", "EFFECTS", "EFFORT", "EFFORTS", "EIGHT", "EITHER", 
		"ELEMENTS", "ENGLAND", "ENGLISH", "ENOUGH", "ENTIRE", "EQUIPMENT", "ESPECIALLY", 
		"ESTABLISHED", "EUROPE", "EVENING", "EVERY", "EVERYTHING", "EVIDENCE", "EXAMPLE", 
		"EXCEPT", "EXISTENCE", "EXPECT", "EXPECTED", "EXPERIENCE", "EXTENT", "FAITH", "FAMILY", 
		"FATHER", "FEDERAL", "FEELING", "FIELD", "FIGURE", "FIGURES", "FILLED", "FINAL", "FINALLY", 
		"FIRST", "FISCAL", "FLOOR", "FOLLOWED", "FOLLOWING", "FORCE", "FORCES", "FOREIGN", "FORMER", 
		"FORMS", "FORWARD", "FOUND", "FREEDOM", "FRENCH", "FRIEND", "FRIENDS", "FRONT", "FUNCTION", 
		"FURTHER", "FUTURE", "GENERAL", "GENERALLY", "GEORGE", "GETTING", "GIRLS", "GIVEN", "GIVES", 
		"GLASS", "GOING", "GOVERNMENT", "GREAT", "GREATER", "GREEN", "GROUND", "GROUP", "GROUPS", 
		"GROWING", "GROWTH", "HANDS", "HAPPENED", "HAVING", "HEARD", "HEART", "HEAVY", "HERSELF", 
		"HIGHER", "HIMSELF", "HISTORY", "HORSE", "HOSPITAL", "HOTEL", "HOURS", "HOUSE", "HOWEVER", 
		"HUMAN", "HUNDRED", "HUSBAND", "IDEAS", "IMAGE", "IMMEDIATELY", "IMPORTANT", "INCLUDE", 
		"INCLUDING", "INCOME", "INCREASE", "INCREASED", "INDEED", "INDIVIDUAL", "INDUSTRIAL", 
		"INDUSTRY", "INFLUENCE", "INFORMATION", "INSIDE", "INSTEAD", "INTEREST", "INTERNATIONAL", 
		"INVOLVED", "ISLAND", "ISSUE", "ITSELF", "JUSTICE", "KENNEDY", "KNOWLEDGE", "KNOWN", "LABOR", 
		"LANGUAGE", "LARGE", "LARGER", "LATER", "LATTER", "LEADERS", "LEARNED", "LEAST", "LEAVE", "LENGTH", 
		"LETTER", "LETTERS", "LEVEL", "LIGHT", "LIKELY", "LINES", "LITERATURE", "LITTLE", "LIVED", "LIVING", 
		"LOCAL", "LONGER", "LOOKED", "LOOKING", "LOWER", "MAJOR", "MAKES", "MAKING", "MANNER", "MARCH", 
		"MARKET", "MARRIED", "MATERIAL", "MATTER", "MAYBE", "MEANING", "MEANS", "MEDICAL", "MEETING", 
		"MEMBER", "MEMBERS", "MERELY", "METHOD", "METHODS", "MIDDLE", "MIGHT", "MILES", "MILITARY", 
		"MILLION", "MINUTES", "MODERN", "MOMENT", "MONEY", "MONTH", "MONTHS", "MORAL", "MORNING", "MOTHER", 
		"MOVED", "MOVEMENT", "MOVING", "MUSIC", "MYSELF", "NATION", "NATIONAL", "NATIONS", "NATURAL", 
		"NATURE", "NEARLY", "NECESSARY", "NEEDED", "NEEDS", "NEGRO", "NEITHER", "NEVER", "NIGHT", 
		"NORMAL", "NORTH", "NOTHING", "NUCLEAR", "NUMBER", "NUMBERS", "OBTAINED", "OBVIOUSLY", 
		"OFFICE", "OFTEN", "OPENED", "OPERATION", "OPPORTUNITY", "ORDER", "ORGANIZATION", "OTHER", 
		"OTHERS", "OUTSIDE", "PAPER", "PARTICULAR", "PARTICULARLY", "PARTS", "PARTY", "PASSED", 
		"PATTERN", "PEACE", "PEOPLE", "PERFORMANCE", "PERHAPS", "PERIOD", "PERSON", "PERSONAL", 
		"PERSONS", "PHYSICAL", "PICTURE", "PIECE", "PLACE", "PLACED", "PLANE", "PLANNING", "PLANS", 
		"PLANT", "POINT", "POINTS", "POLICE", "POLICY", "POLITICAL", "POPULATION", "POSITION", "POSSIBLE", 
		"POWER", "PRESENT", "PRESIDENT", "PRESS", "PRESSURE", "PRICE", "PRINCIPLE", "PRIVATE", "PROBABLY", 
		"PROBLEM", "PROBLEMS", "PROCESS", "PRODUCTION", "PRODUCTS", "PROGRAM", "PROGRAMS", "PROGRESS", 
		"PROPERTY", "PROVIDE", "PROVIDED", "PUBLIC", "PURPOSE", "QUALITY", "QUESTION", "QUESTIONS", "QUITE", 
		"RADIO", "RANGE", "RATHER", "REACHED", "REACTION", "READING", "READY", "REALLY", "REASON", "RECEIVED", 
		"RECENT", "RECENTLY", "RECORD", "RELIGION", "RELIGIOUS", "REMEMBER", "REPORT", "REPORTED", "REQUIRED", 
		"RESEARCH", "RESPECT", "RESPONSIBILITY", "RESULT", "RESULTS", "RETURN", "RETURNED", "RIGHT", "RIVER", 
		"RUNNING", "SALES", "SAYING", "SCHOOL", "SCHOOLS", "SCIENCE", "SEASON", "SECOND", "SECRETARY", 
		"SECTION", "SEEMED", "SEEMS", "SENSE", "SERIES", "SERIOUS", "SERVED", "SERVICE", "SERVICES", 
		"SEVEN", "SEVERAL", "SHALL", "SHORT", "SHOULD", "SHOWED", "SHOWN", "SIMILAR", "SIMPLE", "SIMPLY", 
		"SINCE", "SINGLE", "SITUATION", "SLOWLY", "SMALL", "SOCIAL", "SOCIETY", "SOMETHING", "SOMETIMES", 
		"SOMEWHAT", "SOUND", "SOUTH", "SOUTHERN", "SOVIET", "SPACE", "SPEAK", "SPECIAL", "SPECIFIC", "SPIRIT", 
		"SPRING", "SQUARE", "STAFF", "STAGE", "STAND", "STANDARD", "START", "STARTED", "STATE", "STATEMENTS", 
		"STATES", "STEPS", "STILL", "STOCK", "STOOD", "STOPPED", "STORY", "STRAIGHT", "STREET", "STRENGTH", 
		"STRONG", "STUDENT", "STUDENTS", "STUDY", "SUBJECT", "SUDDENLY", "SUMMER", "SUPPORT", "SURFACE", "SYSTEM", 
		"SYSTEMS", "TABLE", "TAKEN", "TAKING", "TECHNICAL", "TEMPERATURE", "TERMS", "THATS", "THEIR", "THEMSELVES", 
		"THEORY", "THERE", "THEREFORE", "THERES", "THESE", "THING", "THINGS", "THINK", "THINKING", "THIRD", 
		"THIRTY", "THOSE", "THOUGHT", "THREE", "THROUGH", "THROUGH", "THROUGHOUT", "TIMES", "TODAY", "TOGETHER", 
		"TOTAL", "TOWARD", "TRADE", "TRAINING", "TREATMENT", "TRIAL", "TRIED", "TROUBLE", "TRUTH", "TRYING", 
		"TURNED", "TWENTY", "TYPES", "UNDER", "UNDERSTAND", "UNDERSTANDING", "UNION", "UNITED", "UNIVERSITY", 
		"UNTIL", "USING", "USUALLY", "VALUE", "VALUES", "VARIOUS", "VOICE", "VOLUME", "WAITING", "WALKED", 
		"WANTED", "WASHINGTON", "WASNT", "WATER", "WEEKS", "WESTERN", "WHATEVER", "WHERE", "WHETHER", "WHICH", 
		"WHILE", "WHITE", "WHOLE", "WHOSE", "WILLIAM", "WINDOW", "WITHIN", "WITHOUT", "WOMAN", "WOMEN", "WORDS", 
